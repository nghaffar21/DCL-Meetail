        ...
        if (i == 0) {
            let transform = new Transform({
                position: new Vector3(
                    ...
                    Resources.Transforms.DynamicTransforms.SixthFloor.y + Resources.Variables.MeetingFloorFirstRowButtonOffetY+6.1,
            ...
            const transform6 = new Transform({
                position: new Vector3(
                    Resources.Variables.MeetingFloorOffsetX,
                    Resources.Transforms.DynamicTransforms.SixthFloor.y + Resources.Variables.MeetingFloorFirstRowButtonOffetY+6.5,
            ...
            button[i].addComponent(
                new OnPointerDown(() => {
                    Teleport(button[i], new Vector3(0,0,0));
                },
                    {
            ...
            const transform2 = new Transform({
                position: new Vector3(
                    Resources.Variables.MeetingFloorOffsetX,
                    Resources.Transforms.DynamicTransforms.SixthFloor.y + Resources.Variables.MeetingFloorSecondRowButtonOffetY+6.3,
                    Resources.Variables.SecondColumnOffsetZ),
                scale: Resources.Transforms.StaticTransforms.BoxShapeScale
            })
